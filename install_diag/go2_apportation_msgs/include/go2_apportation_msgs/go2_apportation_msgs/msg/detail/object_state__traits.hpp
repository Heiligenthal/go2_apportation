...
#ifndef GO2_APPORTATION_MSGS__MSG__DETAIL__OBJECT_STATE__TRAITS_HPP_
#define GO2_APPORTATION_MSGS__MSG__DETAIL__OBJECT_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const go2_apportation_msgs::msg::ObjectState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const go2_apportation_msgs::msg::ObjectState & msg)
{
  return go2_apportation_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<go2_apportation_msgs::msg::ObjectState>()
{
  return "go2_apportation_msgs::msg::ObjectState";
}

template<>
inline const char * name<go2_apportation_msgs::msg::ObjectState>()
{
  return "go2_apportation_msgs/msg/ObjectState";
}

template<>
struct has_fixed_size<go2_apportation_msgs::msg::ObjectState>
...
template<>
struct has_bounded_size<go2_apportation_msgs::msg::ObjectState>
...
template<>
struct is_message<go2_apportation_msgs::msg::ObjectState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GO2_APPORTATION_MSGS__MSG__DETAIL__OBJECT_STATE__TRAITS_HPP_

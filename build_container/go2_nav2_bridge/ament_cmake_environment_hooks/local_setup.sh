...
: ${AMENT_CURRENT_PREFIX:="/workspace/repo/install_container/go2_nav2_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_nav2_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_nav2_bridge/environment/path.sh"

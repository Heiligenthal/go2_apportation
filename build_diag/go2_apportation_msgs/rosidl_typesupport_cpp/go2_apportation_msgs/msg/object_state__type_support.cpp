...
static const _ObjectState_type_support_symbol_names_t _ObjectState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_apportation_msgs, msg, ObjectState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_apportation_msgs, msg, ObjectState)),
  }
};
...
{
  return &::go2_apportation_msgs::msg::rosidl_typesupport_cpp::ObjectState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, go2_apportation_msgs, msg, ObjectState)() {
  return get_message_type_support_handle<go2_apportation_msgs::msg::ObjectState>();
}

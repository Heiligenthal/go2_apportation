...
#include "go2_apportation_msgs/msg/detail/detection3_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_apportation_msgs::msg::Detection3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_apportation_msgs::msg::Detection3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_apportation_msgs::msg::Detection3D *>(
    untyped_ros_message);
...
{
  return &go2_apportation_msgs::msg::typesupport_fastrtps_cpp::_Detection3D__handle;
}

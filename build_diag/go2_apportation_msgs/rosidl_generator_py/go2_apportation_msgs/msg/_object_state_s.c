...
bool go2_apportation_msgs__msg__object_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_apportation_msgs.msg._object_state.ObjectState", full_classname_dest, 50) == 0);
  }
  go2_apportation_msgs__msg__ObjectState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ObjectState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_apportation_msgs.msg._object_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectState");

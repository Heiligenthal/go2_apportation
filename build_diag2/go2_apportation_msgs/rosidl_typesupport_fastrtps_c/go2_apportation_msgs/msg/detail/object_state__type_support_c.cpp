...
#include "go2_apportation_msgs/msg/detail/object_state__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectState__ros_msg_type = go2_apportation_msgs__msg__ObjectState;
...
size_t get_serialized_size_go2_apportation_msgs__msg__ObjectState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectState__ros_msg_type * ros_message = static_cast<const _ObjectState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_apportation_msgs__msg__ObjectState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_apportation_msgs
size_t max_serialized_size_go2_apportation_msgs__msg__ObjectState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_apportation_msgs__msg__ObjectState;
    is_plain =
      (
...
static size_t _ObjectState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_apportation_msgs__msg__ObjectState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_apportation_msgs, msg, ObjectState)() {

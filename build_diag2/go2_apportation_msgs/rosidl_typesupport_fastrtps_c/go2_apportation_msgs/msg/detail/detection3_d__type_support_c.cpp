...
#include "go2_apportation_msgs/msg/detail/detection3_d__rosidl_typesupport_fastrtps_c.h"
...
using _Detection3D__ros_msg_type = go2_apportation_msgs__msg__Detection3D;
...
static uint32_t _Detection3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_apportation_msgs__msg__Detection3D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_apportation_msgs__msg__Detection3D;
    is_plain =
      (
...
static size_t _Detection3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_apportation_msgs__msg__Detection3D(

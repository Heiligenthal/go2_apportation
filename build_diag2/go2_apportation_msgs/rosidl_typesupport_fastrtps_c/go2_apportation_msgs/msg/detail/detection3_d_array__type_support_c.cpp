...
#include "go2_apportation_msgs/msg/detail/detection3_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_apportation_msgs/msg/detail/detection3_d__functions.h"  // detections
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_go2_apportation_msgs__msg__Detection3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_apportation_msgs__msg__Detection3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_apportation_msgs, msg, Detection3D)();
...
using _Detection3DArray__ros_msg_type = go2_apportation_msgs__msg__Detection3DArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_apportation_msgs, msg, Detection3D
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      go2_apportation_msgs__msg__Detection3D__Sequence__fini(&ros_message->detections);
    }
    if (!go2_apportation_msgs__msg__Detection3D__Sequence__init(&ros_message->detections, size)) {
...
size_t get_serialized_size_go2_apportation_msgs__msg__Detection3DArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection3DArray__ros_msg_type * ros_message = static_cast<const _Detection3DArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_go2_apportation_msgs__msg__Detection3D(
...
static uint32_t _Detection3DArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_apportation_msgs__msg__Detection3DArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_apportation_msgs
size_t max_serialized_size_go2_apportation_msgs__msg__Detection3DArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_apportation_msgs__msg__Detection3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = go2_apportation_msgs__msg__Detection3DArray;
    is_plain =
      (
...
static size_t _Detection3DArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_go2_apportation_msgs__msg__Detection3DArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_apportation_msgs, msg, Detection3DArray)() {

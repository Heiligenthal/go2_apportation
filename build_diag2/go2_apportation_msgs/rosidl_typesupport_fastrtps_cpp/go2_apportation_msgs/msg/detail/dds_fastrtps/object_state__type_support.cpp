...
#include "go2_apportation_msgs/msg/detail/object_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_apportation_msgs::msg::ObjectState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_apportation_msgs::msg::ObjectState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_apportation_msgs::msg::ObjectState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_apportation_msgs::msg::ObjectState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_apportation_msgs::msg::ObjectState *>(
    untyped_ros_message);
...
{
  return &go2_apportation_msgs::msg::typesupport_fastrtps_cpp::_ObjectState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_apportation_msgs, msg, ObjectState)() {
  return &go2_apportation_msgs::msg::typesupport_fastrtps_cpp::_ObjectState__handle;
}

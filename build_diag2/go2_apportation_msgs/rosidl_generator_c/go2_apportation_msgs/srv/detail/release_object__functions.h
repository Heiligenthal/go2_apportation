...
#ifndef GO2_APPORTATION_MSGS__SRV__DETAIL__RELEASE_OBJECT__FUNCTIONS_H_
#define GO2_APPORTATION_MSGS__SRV__DETAIL__RELEASE_OBJECT__FUNCTIONS_H_
...
/// Initialize srv/ReleaseObject message.
/**
...
/// Finalize srv/ReleaseObject message.
/**
...
/// Create srv/ReleaseObject message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * go2_apportation_msgs__srv__ReleaseObject_Request__init().
...
/// Destroy srv/ReleaseObject message.
/**
 * It calls
 * go2_apportation_msgs__srv__ReleaseObject_Request__fini()
...
/// Check for srv/ReleaseObject message equality.
/**
...
/// Copy a srv/ReleaseObject message.
/**
...
/// Initialize array of srv/ReleaseObject messages.
/**
...
/// Finalize array of srv/ReleaseObject messages.
/**
 * It calls
 * go2_apportation_msgs__srv__ReleaseObject_Request__fini()
...
/// Create array of srv/ReleaseObject messages.
/**
 * It allocates the memory for the array and calls
 * go2_apportation_msgs__srv__ReleaseObject_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ReleaseObject messages.
/**
 * It calls
 * go2_apportation_msgs__srv__ReleaseObject_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ReleaseObject message array equality.
/**
...
/// Copy an array of srv/ReleaseObject messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * go2_apportation_msgs__srv__ReleaseObject_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_apportation_msgs
...
/**
 * It calls
 * go2_apportation_msgs__srv__ReleaseObject_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_apportation_msgs
...
/**
 * It allocates the memory for the array and calls
 * go2_apportation_msgs__srv__ReleaseObject_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_apportation_msgs
...
/**
 * It calls
 * go2_apportation_msgs__srv__ReleaseObject_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GO2_APPORTATION_MSGS__SRV__DETAIL__RELEASE_OBJECT__FUNCTIONS_H_

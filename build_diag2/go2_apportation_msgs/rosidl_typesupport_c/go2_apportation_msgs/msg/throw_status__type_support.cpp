...
static const _ThrowStatus_type_support_symbol_names_t _ThrowStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_apportation_msgs, msg, ThrowStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, go2_apportation_msgs, msg, ThrowStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, go2_apportation_msgs, msg, ThrowStatus)() {
  return &::go2_apportation_msgs::msg::rosidl_typesupport_c::ThrowStatus_message_type_support_handle;
}
